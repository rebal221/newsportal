...
if($query)
{
$msg="تم أنشاء فئة فرعية";
}
else{
$error="حدث خظأ ما حاول مرة اخرى";    
} 
}
...
<html lang="en">
    <head>
        ...
        <title>اضافة فئة فرعية سكاي نيوز عربية</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">اضافة فئة فرعية</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>اضافة فئة فرعية</b></h4>
                                    <hr />
...
<?php } ?>
    ...
    <div class="form-group">
                                                    <label class="col-md-2 control-label">فئة فرعية</label>
                                                    <div class="col-md-10">
	                                            ...
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">وصف الفئة الفرعية</label>
	                                                <div class="col-md-10">
