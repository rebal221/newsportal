                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">صفحة حول </h4>
...
<strong>عذرا!</strong> <?php echo htmlentities($error);?></div>
<?php } ?>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>تفاصيل الصفحة</b></h4>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">تحديث و نشر</button>
