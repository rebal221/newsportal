  <div class="col-md-4"> 
          <div class="card mb-4">
            <h5 class="card-header">بحث</h5>
            <div class="card-body">
                   <form name="search" action="search.php" method="post">
              <div class="input-group">
           
        <input type="text" name="searchtitle" class="form-control" placeholder="ابحث عن" required>
          ...
          <!-- Categories Widget -->
          <div class="card my-4">
            <h5 class="card-header">الفئات</h5>
            <div class="card-body">
              <div class="row">
                <div class="col-lg-6">
...
<?php } ?>
          ...
          <div class="card my-4">
            <h5 class="card-header">احدث الأخبار</h5>
            <div class="card-body">
                      <ul class="mb-0">
<?php
